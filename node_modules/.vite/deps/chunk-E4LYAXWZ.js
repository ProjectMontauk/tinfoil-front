...
async function isOpStackChain(chain) {
  ...
  try {
    const { getChainMetadata } = await import("./utils-UVDTLGGH.js");
...
async function estimateGasCost(options) {
  ...
  if (await isOpStackChain(transaction.chain)) {
    const { estimateL1Fee } = await import("./estimate-l1-fee-ETHRYOSM.js");
...
//# sourceMappingURL=chunk-E4LYAXWZ.js.map
