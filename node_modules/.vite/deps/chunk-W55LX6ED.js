...
async function getNFTAsset(options) {
  ...
  switch (true) {
    case erc721: {
      const { getNFT } = await import("./getNFT-JBV6V2E4.js");
      return getNFT(options);
    }
    case erc1155: {
      const { getNFT } = await import("./getNFT-KZKZ7NCZ.js");
      return getNFT(options);
    }
    default: {
...
//# sourceMappingURL=chunk-W55LX6ED.js.map
