...
async function getNFTFromRPC(options) {
  ...
  const [uri, owner] = await Promise.all([
    ...
    options.includeOwner ? import("./ownerOf-DH25NGDH.js").then((m) => m.ownerOf({ contract: options.contract, tokenId })).catch(() => null) : null
  ]);
...
//# sourceMappingURL=chunk-5PRLY4Q6.js.map
