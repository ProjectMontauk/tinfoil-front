  ...
  async getAccount() {
    ...
    const _signTransaction = async (tx) => {
      ...
      const transaction = {
        ...
        gas: hexlify(tx.gas),
        nonce: hexlify(tx.nonce) || toHex(await import("./eth_getTransactionCount-LRHHY2WT.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
...
var InAppWebConnector = class {
  ...
  async passkeyAuth(args) {
    const { PasskeyWebClient } = await import("./passkeys-JPEL6JFI.js");
...
//# sourceMappingURL=web-connector-Y5PE2POD.js.map
