...
async function sendTransaction(options) {
  ...
  if (transaction.eip712) {
    const { sendEip712Transaction } = await import("./send-eip712-transaction-HRDC5FQ7.js");
  ...
  if (gasless) {
    const { sendGaslessTransaction } = await import("./send-gasless-transaction-AQV2G4WL.js");
...
//# sourceMappingURL=chunk-ZDRPKWVC.js.map
