...
async function createWalletConnectClient(options) {
  ...
  walletConnectClient.on("session_proposal", async (event) => {
    const { onSessionProposal } = await import("./session-proposal-WXHLIMBW.js");
  ...
  walletConnectClient.on("session_request", async (event) => {
    const { fulfillRequest } = await import("./session-request-REUTDVB5.js");
...
//# sourceMappingURL=chunk-ZWDATDIR.js.map
