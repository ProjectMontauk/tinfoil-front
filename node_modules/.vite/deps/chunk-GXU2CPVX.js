...
import {
  ...
  toBigInt
} from "./chunk-JMOHKTA4.js";
import {
  parseTypedData,
  trackTransaction
} from "./chunk-IAMVU67T.js";
import {
  parseEventLogs,
  prepareEvent
...
async function createSmartAccount(options) {
  ...
  const account = {
    ...
    async signMessage({ message }) {
      ...
      const { smartAccountSignMessage } = await import("./signing-GP3H44FX.js");
    ...
    async signTypedData(typedData) {
      ...
      const { smartAccountSignTypedData } = await import("./signing-GP3H44FX.js");
...
//# sourceMappingURL=chunk-GXU2CPVX.js.map
