...
} from "./chunk-SHMPOGED.js";
import {
  isContractDeployed
} from "./chunk-OCUM3LYH.js";
import {
  isZkSyncChain
} from "./chunk-PACFWEKZ.js";
import {
  getContract
...
function coinbaseWalletSDK(args) {
  ...
  return {
    ...
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbase-web-HWX67MWM.js");
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbase-web-HWX67MWM.js");
      const provider = await args.providerFactory();
...
function ecosystemWallet(...args) {
  ...
  return createInAppWallet({
    ...
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-Y5PE2POD.js");
...
function smartWallet(createOptions) {
  ...
  return {
    ...
    autoConnect: async (options) => {
      const { connectSmartAccount: connectSmartWallet } = await import("./smart-23EHOPV5.js");
    ...
    disconnect: async () => {
      if (account) {
        const { disconnectSmartAccount } = await import("./smart-23EHOPV5.js");
      ...
      const wallet = {
        ...
        autoConnect: async (options) => {
          ...
          if (id !== "walletConnect" && injectedProvider(id)) {
            const { autoConnectEip1193Wallet } = await import("./injected-YWVZSNOY.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-OKYTFC3Q.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            const { connectWC } = await import("./controller-OKYTFC3Q.js");
          ...
          if (injectedProvider(id) && !forceWalletConnectOption) {
            const { connectEip1193Wallet } = await import("./injected-YWVZSNOY.js");
...
//# sourceMappingURL=chunk-GX44DYFG.js.map
