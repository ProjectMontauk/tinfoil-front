...
async function toSerializableTransaction(options) {
  ...
  if (isZkSync) {
    const { getZkGasFees } = await import("./send-eip712-transaction-HRDC5FQ7.js");
  ...
  let [data, nonce, gas, feeData, to, accessList, value, authorizationList, type] = await Promise.all([
    ...
    (async () => {
      ...
      return from ? await import("./eth_getTransactionCount-LRHHY2WT.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
...
//# sourceMappingURL=chunk-IKNCNHEM.js.map
