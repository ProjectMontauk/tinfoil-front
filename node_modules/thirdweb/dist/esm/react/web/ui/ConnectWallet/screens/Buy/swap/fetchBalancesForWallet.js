...
export async function fetchBalancesForWallet({ wallet, accountAddress, sourceSupportedTokens, toChain, toToken, tokenAmount, mode, client, }) {
        ...
        for (const token of tokens) {
            ...
            rpcCalls.push((async () => {
                try {
                    ...
                    const include = token.address === destinationToken.address &&
                        chain.id === toChain.id
